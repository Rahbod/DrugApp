...
public class Drug2 {
    ...
    public Drug2(String name, String namePersian, String brand, String pregnancy, String lactation, String kids, String seniors, String howToUse, String product, String pharmacodynamic, String usage, String prohibition, String caution, String doseAdjustment, String complication, String interference, String effectOnTest, String overDose, String description, String relationWithFood, int status, String lastModified) {
        this.name = name;
        this.namePersian = namePersian;
        this.brand = brand;
        this.pregnancy = pregnancy;
    ...
    public Drug2(int favorite) {
        this.favorite = favorite;
    }

    public Drug2(String name) {
        this.name = name;
    }

    public Drug2(int id, String name, String brand, String pregnancy, String lactation, String kids, String seniors, String howToUse, String product, String pharmacodynamic, String usage, String prohibition, String caution, String doseAdjustment, String complication, String interference, String effectOnTest, String overDose, String description, String relationWithFood, int status, String lastModified) {
        this.id = id;
        this.name = name;
        this.brand = brand;
        this.pregnancy = pregnancy;
    ...
    public Drug2(String name, String brand, String pregnancy, String lactation, String kids, String seniors, String howToUse, String product, String pharmacodynamic, String usage, String prohibition, String caution, String doseAdjustment, String complication, String interference, String effectOnTest, String overDose, String description, String relationWithFood, int status, String lastModified) {
        this.name = name;
        this.brand = brand;
        this.pregnancy = pregnancy;
        this.lactation = lactation;
