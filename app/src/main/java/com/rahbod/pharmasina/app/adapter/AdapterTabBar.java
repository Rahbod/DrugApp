...
public class AdapterTabBar extends FragmentPagerAdapter {
    ...
    public View getTabView(int position) {
        ...
        View view = LayoutInflater.from(context).inflate(com.rahbod.pharmasina.app.R.layout.tab, null);
        TextView txt = view.findViewById(com.rahbod.pharmasina.app.R.id.txtTitle);
