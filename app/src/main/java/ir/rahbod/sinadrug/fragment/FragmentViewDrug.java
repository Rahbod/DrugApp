...
public class FragmentViewDrug extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(getActivity()).inflate(ir.rahbod.sinadrug.app.R.layout.view_drug, null);

        WebView webView = view.findViewById(ir.rahbod.sinadrug.app.R.id.web_view_drug);
        ...
        relativebottom = view.findViewById(ir.rahbod.sinadrug.app.R.id.relative_bottom);
        ...
        Animation animationToDown = AnimationUtils.loadAnimation(getActivity(), ir.rahbod.sinadrug.app.R.anim.slide_down);
        ...
        FontTextViewBold nameDrug = getActivity().findViewById(ir.rahbod.sinadrug.app.R.id.name_drug);
        FontTextView persianName = getActivity().findViewById(ir.rahbod.sinadrug.app.R.id.persian_name);
...
//        check exist in favorite
        if (dbHelper.checkFavorite(ID)) {
            addToBasketText.setTextColor(getResources().getColor(ir.rahbod.sinadrug.app.R.color.table_link));
            addToBasketText.setText("حذف از نشان شده ها");
            addToBasketImage.setColorFilter(getResources().getColor(ir.rahbod.sinadrug.app.R.color.table_link));
        } else {
            addToBasketText.setText("نشان کردن");
            addToBasketText.setTextColor(getResources().getColor(ir.rahbod.sinadrug.app.R.color.bottom_layout_text));
            addToBasketImage.setImageResource(ir.rahbod.sinadrug.app.R.drawable.star_icon_view_drug2);
        }
        ...
        linearBasket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!dbHelper.checkFavorite(ID)) {
                    ...
                    addToBasketText.setText("نشان کردن");
                    addToBasketText.setTextColor(getResources().getColor(ir.rahbod.sinadrug.app.R.color.bottom_layout_text));
                    addToBasketImage.setColorFilter(getResources().getColor(ir.rahbod.sinadrug.app.R.color.bottom_layout_text));
