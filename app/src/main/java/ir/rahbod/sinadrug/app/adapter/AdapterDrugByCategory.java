...
public class AdapterDrugByCategory extends RecyclerView.Adapter<AdapterDrugByCategory.listViewHolder> {
    ...
    public listViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(ir.rahbod.sinadrug.app.R.layout.rec_search, parent, false);
    ...
    public class listViewHolder extends RecyclerView.ViewHolder {
        ...
        public listViewHolder(View itemView) {
            super(itemView);
            txt = itemView.findViewById(ir.rahbod.sinadrug.app.R.id.txtTitle);
            relItem = itemView.findViewById(ir.rahbod.sinadrug.app.R.id.relativeLayoutRecHome);
        }
    }
