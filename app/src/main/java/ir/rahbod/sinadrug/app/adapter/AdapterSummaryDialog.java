...
public class AdapterSummaryDialog extends RecyclerView.Adapter<AdapterSummaryDialog.listViewHolder> {
    ...
    public listViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(ir.rahbod.sinadrug.app.R.layout.rec_summary_dialog, parent, false);
    ...
    public class listViewHolder extends RecyclerView.ViewHolder {
        ...
        public listViewHolder(View itemView) {
            ...
            txtChar = itemView.findViewById(ir.rahbod.sinadrug.app.R.id.txtChar);
        }
    }
}
